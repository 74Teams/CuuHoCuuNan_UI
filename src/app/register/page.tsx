...
export default function RegisterPage() {
  ...
  const handleRoleChange = (value: string) => {
    setFormData((prev) => ({ ...prev, role: value as ApiRole }));
  };
          ...
          <div className="flex flex-col justify-center gap-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl font-bold leading-tight">
                Trở thành phần đội <span className="text-emerald-400">cứu hộ</span>
              </h1>
              <p className="text-lg text-slate-300 leading-relaxed max-w-md">
                Đăng ký tài khoản và gia nhập mạng lưới có động lực cứu hộ
                tại văn phòng của bạn. Hỗ trợ các yêu cầu khẩn cấp nhất thắng.
              </p>
            </div>

            {/* Role Guide */}
            <div className="space-y-3">
              <p className="text-sm font-semibold text-slate-300">Các vai trò khả dụng:</p>
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-slate-200">Rescuer</p>
                    <p className="text-sm text-slate-400">Thành viên đội cứu hộ</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Điều phối yêu cầu cứu hộ</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Yêu cầu cứu hộ khi cần thiết</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.role} onValueChange={handleRoleChange}>
                      <SelectTrigger className="bg-slate-800/50 border-slate-700/50 focus:border-emerald-500/50">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="bg-slate-900 border-slate-700">
                        <SelectItem value="User">Người dùng - Gửi yêu cầu</SelectItem>
                        <SelectItem value="Rescuer">Rescuer - Thành viên đội</SelectItem>
                        <SelectItem value="Dispatcher">Dispatcher - Điều phối</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="mt-5 flex items-start gap-3 rounded-lg border border-blue-500/20 bg-blue-500/5 p-3">
                  ...
                  <p className="text-xs text-slate-300">
                    Mật khẩu phải ít nhất 8 ký tự và có chữ, số, ký tự đặc biệt
                  </p>
                </div>
              </CardContent>
